...
class RawDeltaTable:
    ...
    def files_by_partitions(
        self, partitions_filters: FilterType | None
    ) -> list[str]: ...
    def files(self, partition_filters: FilterType | None) -> list[str]: ...
    def file_uris(self, partition_filters: FilterType | None) -> list[str]: ...
    def vacuum(
        self,
        dry_run: bool,
    ...
    def compact_optimize(
        self,
        partition_filters: FilterType | None,
        target_size: int | None,
        max_concurrent_tasks: int | None,
        min_commit_interval: int | None,
        writer_properties: dict[str, str | None] | None,
        custom_metadata: dict[str, str] | None,
    ) -> str: ...
    ...
    def dataset_partitions(
        self, schema: pyarrow.Schema, partition_filters: FilterType | None
    ) -> list[Any]: ...
    ...
    def repair(
        self, dry_run: bool, custom_metadata: dict[str, str] | None
    ) -> str: ...
    def update(
        self,
    ...
    def merge_execute(
        ...
        custom_metadata: dict[str, str] | None,
        safe_cast: bool,
        matched_update_updates: list[dict[str, str]] | None,
        matched_update_predicate: list[str | None] | None,
        matched_delete_predicate: list[str] | None,
        matched_delete_all: bool | None,
        not_matched_insert_updates: list[dict[str, str]] | None,
        not_matched_insert_predicate: list[str | None] | None,
        not_matched_by_source_update_updates: list[dict[str, str]] | None,
        not_matched_by_source_update_predicate: list[str | None] | None,
        not_matched_by_source_delete_predicate: list[str] | None,
        not_matched_by_source_delete_all: bool | None,
    ) -> str: ...
...
def convert_to_deltalake(
    uri: str,
    partition_by: pyarrow.Schema | None,
